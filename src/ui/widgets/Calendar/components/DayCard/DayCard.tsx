			...
			<div className={styles.dayCardBody}>
				...
				<ScheduleBlock
					...
					description={`У меня есть два цвета --evening-bg: rgb(238 242 255 / 1); и --evening-accent: rgb(129
							140 248 / 1);, они ассоциируются с вечером, цвет бэкграунда нежный, а акцент более
							яркий его оттенок, подбери цвета для ночи, утра и дня У меня есть два цвета
							--evening-bg: rgb(238 242 255 / 1); и --evening-accent: rgb(129 140 248 / 1);, они
							ассоциируются с вечером, цвет бэкграунда нежный, а акцент более яркий его оттенок,
							подбери цвета для ночи, утра и дня У меня есть два цвета --evening-bg: rgb(238 242 255
							/ 1); и --evening-accent: rgb(129 140 248 / 1);, они ассоциируются с вечером, цвет
							бэкграунда нежный, а акцент более яркий его оттенок, подбери цвета для ночи, утра и
							дня`}
					title={<p>Вечер</p>}
					variant={ScheduleBlockVarints.MEAL}
